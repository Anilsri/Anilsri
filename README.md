...
- Associate Lead Software engineer (UI(HTML/CSS/SCSS/LESS/PostCSS/Prototype/BEM/Atomic Design/Responsive design/web component), Bootstrap, ReactJs, VueJS, jQuery, Javascript, Type Script, Web Components, Storybook, Lit, Elix, Material design, Gulp, rollup, webpack, vite, Quasar, NPM, RUSH, Ag-Grid, ChartJs, Google tag manager, Beamer, Appcues, Intercom, MS Clarity, Planhat, React-Native, Redux, Vuex, Vuetify, GraphQL)
